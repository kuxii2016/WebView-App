...
<td><input style="width:150;height:32px" type="submit" value="Tools"></td>
</form>
<form action="gaertnerrei.php">
<td><input style="width:150;height:32px" type="submit" value="Gärtnerrei"></td>
</form>
</tr>

<tr>
<form action="blocks.php">
<td><input style="width:150;height:32px" type="submit" value="Blöcke"></td>
</form>
<form action="foot.php">
<td><input style="width:150;height:32px" type="submit" value="Nahrung"></td>
</form>
</tr>

<tr>
<form action="shop.php">
<td><input style="width:150;height:32px" type="submit" value="Uncraftbares!!"></td>
</form>
<form action="shop.php">
<td><input style="width:150;height:32px" type="submit" value="Ramsch!!"></td>
</form>
</tr>

<tr>
<form action="advanceSoloar.php">
<td><input style="width:150;height:32px" type="submit" value="Advance Solar"></td>
</form>
<form action="exshop.php">
<td><input style="width:150;height:32px" type="submit" value="Verzierte Blöcke"></td>
</form>
</tr>
</form>
</table>
