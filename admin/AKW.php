...
<table>
	<tr>
		...
		<form action="../index.php">
	<td>
		<input style="width:100;height:32px" type="submit" value="Startseite"></td>
			</form>
				<form action='akwleer.php' method='POST'>
			<td>
		<input style="width:100;height:32px" type="submit" value="Löschen" name="Löschen" /></td>
	</form>
	<form action='add.php' method='POST'>
	<td>
		<input style="width:110;height:32px" type="submit" value="Zähler Funktion" name="Zähler Funktion" /></td>
	</form>
		<form action='kontolle.php' method='POST'>
	<td>
