...
fclose($myfile);
	...
	$status = "<font color='orange'>Noch kein zugeordneter Zähler, Bestelle einen.!";
}
?>
...
<table>
	<tr>
		<form action="index.php">
			<td>
		<input style="width:110;height:32px" type="submit" value="Start Seite"></td>
	</form>
	<form action="order.php">
			<td>
		<input style="width:111;height:32px" type="submit" value="Bestelle Anschluss"></td>
	</form>
		<form action="stoerung.php">
			<td>
		<input style="width:111;height:32px" type="submit" value="Melde Störung"></td>
	</form>
<?php if ($gesammtkosten >= 50) {
	echo' 
		<form action="Edonate.php" method="POST">
			<td>
		<input style="width:110;height:32px" type="submit" value="Begleichen" name="Begleichen" />
		</td>
	</form> ';
}
else {
