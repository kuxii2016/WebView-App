...
$_id = $_POST['id'][0];
//Geld Lesen
$myfile = fopen("../cache/plot/$_id.txt", "r");
$data = fgets ($myfile);
fclose($myfile);	
?>
<!doctype html> 
...
<head>
	...
	<title>EE :: Usergrundstücke</title> 
</head> 
<body> 

<h1>Grundstücks Support Daten</h1> </br>
<?
...
?>
Spieler Name:<?php echo " $_id ";?><br><br>
<?php echo "Grundstücke $data"; ?>
<br> <br> 
<table>
<tr>
<form method="POST">
Spieler Name:  <input type="text" name="id[]" value="" /> <br> <br>
