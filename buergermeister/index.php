...
<head>
	...
	<title>EE :: Bürger Meister Menü</title> 
</head> 
<body>
<h1>Bürger Meister Menü</h1>

<table>
<tr>
<form action="Plots.php">
<td><input style="width:150;height:32px" type="submit" value="Spieler Grundstücke"></td>
</form>
...
<td><input style="width:150;height:32px" type="submit" value="Bürger Liste"></td>
</form>
<form action="../staat/pay.php">
<td><input style="width:150;height:32px" type="submit" value="Spieler Bezahlung"></td>
</form>
</tr>

<tr>
<form action="../staat/index.php">
<td><input style="width:150;height:32px" type="submit" value="Staats Kasse"></td>
</form>
<form action="../staat/shop.php">
<td><input style="width:150;height:32px" type="submit" value="Staats Shop"></td>
</form>
</tr>
