...
<?php
	...
	//AKW KONTOSTAND
	$myfile = fopen("/var/www/html/daten/bank/Akw/Akw-9e95b13e-4ab9-40a7-8cfe-9eed07f80d64.txt", "w");
	...
	$rcon->sendCommand("tell $username Es wurden $aktuellBezahlt € für Strom Abgebucht");
	}
	sleep(0.2);
	...
	//schreibt die Zeit ins Doc.
	$myfile = fopen("/var/www/html/daten/bank/Akw/Akw-9e95b13e-4ab9-40a7-8cfe-9eed07f80d64-date.html", "a");
	fwrite ($myfile, $datum. "</br>");
	fclose($myfile);
	//schreibt die betrag ins Doc.
	$myfile = fopen("/var/www/html/daten/bank/Akw/Akw-9e95b13e-4ab9-40a7-8cfe-9eed07f80d64-in.html", "a");
	fwrite ($myfile, $FGKosten. " €  </br>");
	fclose($myfile);	
	//schreibt die verwendungs Zweck ins Doc.
	$myfile = fopen("/var/www/html/daten/bank/Akw/Akw-9e95b13e-4ab9-40a7-8cfe-9eed07f80d64-vz.html", "a");
	fwrite ($myfile,"Stromkosten: $username Ges. Verbrauch $GKEU kEU/t</br>");
	fclose($myfile);	
	//schreibt die ausgabe Zweck ins Doc.
	$myfile = fopen("/var/www/html/daten/bank/Akw/Akw-9e95b13e-4ab9-40a7-8cfe-9eed07f80d64-out.html", "a");
	fwrite ($myfile, "&nbsp;" ."</br>");
	fclose($myfile);
