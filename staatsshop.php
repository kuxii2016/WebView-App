...
<table>
<tr>
<form action="blockstaatsshop.php">
<td><input style="width:150;height:32px" type="submit" value="Basic Blocks"></td>
</form>
<form action="exshopstaat.php">
<td><input style="width:150;height:32px" type="submit" value="Sonder Blocks"></td>
</form>
</tr>

<tr>
<form action="rails.php">
<td><input style="width:150;height:32px" type="submit" value="Schienen"></td>
</form>
