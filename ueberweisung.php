...
<?php
	...
	$datum = date("d.m/H:i", $timestamp);
	//schreibt die Zeit ins Doc.
	$myfilea = fopen("/var/www/html/daten/bank/$sn-$uuids-date.html", "a");
	fwrite ($myfilea, $datum. "</br>");
	fclose($myfilea);
	//schreibt die betrag ins Doc.
	$myfilea = fopen("/var/www/html/daten/bank/$sn-$uuids-in.html", "a");
	fwrite ($myfilea, $summe. " € </br>");
	fclose($myfilea);	
	//schreibt die verwendungs Zweck ins Doc.
	$myfilea = fopen("/var/www/html/daten/bank/$sn-$uuids-vz.html", "a");
	fwrite ($myfilea, $username. " | " .$vz ."</br>");
	fclose($myfilea);	
	//schreibt die ausgabe Zweck ins Doc.
	$myfilea = fopen("/var/www/html/daten/bank/$sn-$uuids-out.html", "a");
	fwrite ($myfilea, "&nbsp;" ."</br>"); 
	fclose($myfilea);
...
<table>
	<tr>
		<form  method="POST">
			...
			<input type="fiel2" 	name="uuid[]"	value="UUID"><br><br>
...
<tr>
<td>
<input type="submit" value="Los" name="kaufen" style="color:white; background-color:red; width:140;height:32px"></td>
</form><td>
	<form action="konto.php">
		<td>
			<input style="width:140;height:32px" type="submit" value="Zurück"></td>
		</form><td>
	<form action="Uleer.php">
		<td>
			<input style="width:140;height:32px" type="submit" value="Bereinigen"></td>
		</form>
	</tr>
</table>
