...
<table style="width:90%" border=0 bgcolor=#2E2E2E>
  ...
  <tr>
    ...
    <td><?php echo "<img src=\img/carrot.png ALT=40&euro;, title=40&euro;>";?></td> 
    <td><font color="white">20 €</td>
  </tr>
  <tr>
    <td><font color="white">&nbsp;&nbsp;&nbsp;&nbsp;2 </td>
    <td><?php echo "<img src=\img/potato.png ALT=20&euro;, title=20&euro;>";?></td>
    <td><font color="white">10 €</td>
  </tr>
   <tr>
	<td><font color="white">&nbsp;&nbsp;&nbsp;&nbsp;3 </td>
    <td><?php echo "<img src=\img/cactus_side.png ALT=40&euro;, title=40&euro;>";?></td>
   <td><font color="white">4 €</td>
  </tr>
    <tr>
	<td><font color="white">&nbsp;&nbsp;&nbsp;&nbsp;4 </td>
    <td><?php echo "<img src=\img/seeds_melon.png ALT=40&euro;, title=40&euro;>";?></td>
    <td><font color="white">4 €</td>
  </tr>  
    <tr>
     <td><font color="white">&nbsp;&nbsp;&nbsp;&nbsp;5 </td>
    <td><?php echo "<img src=\img/seeds_pumpkin.png ALT=400&euro;, title=400&euro;>";?></td> 
    <td><font color="white">2 €</td>
  </tr>
    <tr>
    <td><font color="white">&nbsp;&nbsp;&nbsp;&nbsp;6 </td>
    <td><?php echo "<img src=\img/seeds_wheat.png ALT=20&euro;, title=20&euro;>";?></td>
    <td><font color="white">6 €</td>
  </tr>
    <tr>
	<td><font color="white">&nbsp;&nbsp;&nbsp;&nbsp;7 </td>
    <td><?php echo "<img src=\img/reeds.png ALT=40&euro;, title=40&euro;>";?></td>
    <td><font color="white">2 €</td>
  </tr>  
    <tr>
     <td><font color="white">&nbsp;&nbsp;&nbsp;&nbsp;8 </td>
    <td><?php echo "<img src=\img/weed.png ALT=400&euro;, title=400&euro;>";?></td> 
    <td><font color="white">10 €</td>
  </tr>
</table>
