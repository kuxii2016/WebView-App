...
<table style="width:90%" border=0 bgcolor=#2E2E2E>
  ...
  <tr>
    ...
    <td><?php echo "<img src=brick.png ALT=40&euro;, title=40&euro;>";?></td> 
    <td><font color="white">20 €</td>
  </tr>
  <tr>
    <td><font color="white">&nbsp;&nbsp;&nbsp;&nbsp;2 </td>
    <td><?php echo "<img src=stonebrick.png ALT=20&euro;, title=20&euro;>";?></td>
    <td><font color="white">10 €</td>
  </tr>
   <tr>
	<td><font color="white">&nbsp;&nbsp;&nbsp;&nbsp;3 </td>
    <td><?php echo "<img src=cobblestone.png ALT=40&euro;, title=40&euro;>";?></td>
   <td><font color="white">4 €</td>
    ...
    <td><?php echo "<img src=sandstone_smooth.png ALT=400&euro;, title=400&euro;>";?></td> 
    <td><font color="white">2 €</td>
  </tr>
    <tr>
    ...
    <td><?php echo "<img src=nether_brick.png ALT=40&euro;, title=40&euro;>";?></td>
    <td><font color="white">2 €</td>
  </tr>  
    <tr>
     <td><font color="white">&nbsp;&nbsp;&nbsp;&nbsp;8 </td>
    <td><?php echo "<img src=netherrack.png ALT=400&euro;, title=400&euro;>";?></td> 
    <td><font color="white">10 €</td>
  </tr>
</table>
