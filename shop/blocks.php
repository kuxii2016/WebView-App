...
<table style="width:90%" border=0 bgcolor=#2E2E2E>
  ...
  <tr>
    ...
    <td><?php echo "<img src=\img/brick.png ALT=40&euro;, title=40&euro;>";?></td> 
    <td><font color="white">20 €</td>
  </tr>
  <tr>
    <td><font color="white">&nbsp;&nbsp;&nbsp;&nbsp;2 </td>
    <td><?php echo "<img src=\img/stonebrick.png ALT=20&euro;, title=20&euro;>";?></td>
    <td><font color="white">10 €</td>
  </tr>
   <tr>
	<td><font color="white">&nbsp;&nbsp;&nbsp;&nbsp;3 </td>
    <td><?php echo "<img src=\img/cobblestone.png ALT=40&euro;, title=40&euro;>";?></td>
   <td><font color="white">4 €</td>
  </tr>
    <tr>
	<td><font color="white">&nbsp;&nbsp;&nbsp;&nbsp;4 </td>
    <td><?php echo "<img src=\img/stone.png ALT=40&euro;, title=40&euro;>";?></td>
    <td><font color="white">4 €</td>
  </tr>  
    <tr>
     <td><font color="white">&nbsp;&nbsp;&nbsp;&nbsp;5 </td>
    <td><?php echo "<img src=\img/sandstone_smooth.png ALT=400&euro;, title=400&euro;>";?></td> 
    <td><font color="white">2 €</td>
  </tr>
    <tr>
    <td><font color="white">&nbsp;&nbsp;&nbsp;&nbsp;6 </td>
    <td><?php echo "<img src=\img/gravel.png ALT=20&euro;, title=20&euro;>";?></td>
    <td><font color="white">6 €</td>
  </tr>
    <tr>
	<td><font color="white">&nbsp;&nbsp;&nbsp;&nbsp;7 </td>
    <td><?php echo "<img src=\img/nether_brick.png ALT=40&euro;, title=40&euro;>";?></td>
    <td><font color="white">2 €</td>
  </tr>  
    <tr>
     <td><font color="white">&nbsp;&nbsp;&nbsp;&nbsp;8 </td>
    <td><?php echo "<img src=\img/netherrack.png ALT=400&euro;, title=400&euro;>";?></td> 
    <td><font color="white">10 €</td>
  </tr>
</table>
...
?>
<form method="POST">
	<input type="radio" 	id="1" name="Zahlmethode" 	value="45">  	<label for="1"> 1</label>
	<input type="radio" 	id="2" name="Zahlmethode" 	value="98">  	<label for="2"> 2</label> 
	<input type="radio" 	id="3" name="Zahlmethode" 	value="4">  	<label for="3"> 3</label>
	<br>
	<input type="radio" 	id="4" name="Zahlmethode" 	value="1">  	<label for="4"> 4</label> 
	<input type="radio" 	id="5" name="Zahlmethode" 	value="24">  	<label for="5"> 5</label>
	<input type="radio" 	id="6" name="Zahlmethode" 	value="13">  	<label for="6"> 6</label>
	<br>
	<input type="radio" 	id="7" name="Zahlmethode" 	value="112">  	<label for="7"> 7</label>
	<input type="radio" 	id="8" name="Zahlmethode" 	value="87">  	<label for="8"> 8</label> <br>
