...
<head>
	...
	<title>NG :: Spieler Gewerbe</title> 
</head> 
<body>
<h1>Spieler Gewerbe</h1>

<table>
<tr>
<form action="index.php">
<td><input style="width:150;height:32px" type="submit" value="Kuxii - Soft"></td>
</form>
<form action="index.php">
<td><input style="width:150;height:32px" type="submit" value="Heggens Pressure"></td>
</form>
</tr>

<tr>
<form action="index.php">
<td><input style="width:150;height:32px" type="submit" value="CHILLERKINGS Erze"></td>
</form>
<form action="index.php">
<td><input style="width:150;height:32px" type="submit" value="EmuNator88 - Dienste"></td>
</form>
</tr>
